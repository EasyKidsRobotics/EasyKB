...
Blockly.Blocks['easykb_writeio'] = {
  init: function() {
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldDropdown([["D1","D1"], ["D2","D2"], ["D3","D3"], ["D4","D4"], ["D5","D5"], ["D6","D6"]]), "EasyKB WriteIOPIN")
        this.appendDummyInput()
        .appendField("to")
...
Blockly.Blocks['easykb_motor_stop'] = {
  init: function() {
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldDropdown([["1","1"], ["2","2"],["3","3"], ["4","4"]]), "EasyKB MotorStop");
    this.setColour(270);
    this.setInputsInline(true);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
...
Blockly.Blocks['easymotorstopall'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("EasyKB: Motor Stop All")
    this.setInputsInline(true);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(300);
